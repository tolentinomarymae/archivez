                                ...
                                <div class="card-body p-1">
                                    <div class="row mb-5">
                                        <div class="col-12 text-center mt-5 mb-4">
                                            <h1 class="mb-2 text-uppercase"><?= $bookmark['researchtitle'] ?></h1>
                                        </div>
                                        <div class="col-md-6">
                                            <h4 class="text-muted text-uppercase mb-2">About the Author/s</h4>
                                            <p class="mb-4">
                                                Author/s: <strong><?= $bookmark['author'] ?></strong><br /> ID Number:<strong> <?= $bookmark['idnumber'] ?></strong><br /> Year and Section: <strong><?= $bookmark['gradelevel'] ?> <?= $bookmark['section'] ?></strong><br />
                                            </p>
                                        </div>
                                        <div class="col-md-6">
                                            <h4 class="text-muted text-uppercase mb-2">About the Research</h4>
                                            <p class="mb-4">
                                                Upload Date: <strong><?= $bookmark['uploaddate'] ?></strong><br /> Status:<strong> <?= $bookmark['status'] ?></strong><br /> Subject: <strong><?= $bookmark['subject'] ?></strong><br />Submitted to: <strong><?= $bookmark['submittedto'] ?></strong><br />
                                            </p>
                                        </div>
                                    </div> <!-- /.row -->
                                    <div class="row mb-5">
                                        <div class="col-md-12">
                                            <p>Keywords: <strong><i><?= $bookmark['keywords'] ?></i></strong></p>
                                            <p class="mb-4">Citation: <strong><i><?= $bookmark['citation'] ?></i></strong></p>
                                            <p class="mb-4">Abstract: <strong><?= $bookmark['abstract'] ?></strong></p><?= $bookmark['file'] ?>
                                        </div>
                                    </div> <!-- /.card -->
                                </div>
                            </div>
