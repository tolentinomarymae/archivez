                            ...
                            <form action="/addresearch" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="type" class="form-control" name="submittedto" id="submittedto" placeholder="Teacher">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="subject">Subject</label>
                                        <input type="type" class="form-control" name="subject" id="subject" placeholder="Subject">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="type" class="form-control" name="section" id="section" placeholder="Section">
