      <main role="main" class="main-content">
                              ...
                              <div class="col-lg-4">
                                  ...
                                  <div class="card shadow mb-2">
                                      <div class="card-body">
                                          <div class="row align-items-center">
                                              <div class="col">
                                                  <small class="text-muted mb-1">Number of Research Paper Evaluated</small>
                                                  <h3 class="card-title mb-0"><?= $commentedResearch ?></h3>
                                              </div>
                                              <div class="col-4 text-right">
                                                  <span class="fe fe-edit-2 text-warning fe-12" style="font-size: xx-large;"></span>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
          ...
          <!-- Add this in your HTML where you want the line chart to appear -->
          <div class="my-4">
